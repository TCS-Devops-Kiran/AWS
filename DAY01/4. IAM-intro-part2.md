##  Enable Billing Access for IAM Users (Markdown Format)
...
##  Attach Billing Policy to IAM User (Markdown Format)
...
- Search and select one of the following policies:
  - AWSBillingReadOnlyAccess (view only)
  - AWSBillingFullAccess (view and manage billing)

## Step 4: Apply the Policy
- Click "Next" and then "Add permissions"

The IAM user can now access billing information by logging in using their IAM sign-in URL.
